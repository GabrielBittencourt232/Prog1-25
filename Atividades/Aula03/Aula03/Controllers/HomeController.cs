...
public class HomeController : Controller
{
    ...
    public string GetFor(int x)
    {
        /*
            ...
            Inicizalizador: elemento contador. Tradicionalmente utilziado o i = índice
            Expressão condicional: Específica o teste a ser verificado quando o loop estiver executado o número definido de iterações (flag);
            Expressão de repetição: Especifíca a ação a ser executada com a variável contadora. Geralmente um acúmulo ou decréscimo (acumulador);            
         */
    ...
    {
        /*
            O comando foreach (para cada) é utilizado para iterar uma sequência de itens em uma coleção
